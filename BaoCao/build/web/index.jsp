<%-- 
    Document   : index.jsp
    Created on : Aug 16, 2022, 11:19:23 PM
    Author     : havan
--%>
                        ...
                        <div class="wrap d-md-flex">
                            <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
                                <div class="text w-100">
                                    ...
                                    <a href="Signin.jsp" class="btn btn-white btn-outline-white">Đăng ký</a>
                                    
                                    <br><a href="index.jsp"><p>Quay về trang chủ</p></a>
                                </div>
                            </div>
                            <div class="login-wrap p-4 p-lg-5">
                                ...
                                <form method="post" action="LogInServlet" class="signin-form">
                                    <div class="form-group mb-3">
                                        <label class="label" for="name">Số điện thoại</label>
                                        <input type="text" name="Gamil" class="form-control" placeholder="Gmail" required>
                                    </div>
                                    <div class="form-group mb-3">
