...
<html lang="en">
    ...
    <body>
        ...
        <form action="SearchSevlets" method="get" id="search-form">
    <input type="search" placeholder="Tìm kiếm..." name="tab" id="search-box">
            ...
            <div class="box-container">
                ...
                <c:forEach items="${listMenu}" var="menu">
                    <div class="box">
                        ...
                        <div class="content">
                            ...
                            <h3>${menu.getTenMon()}</h3>
                            <p>${menu.getMoTa()}</p>
                            <p>${menu.getMaMon()}</p>
                            <a href="#" class="btn">Thêm vào giỏ</a>
                            <span class="price">${menu.getGiaMon()}</span>
                        </div>
                ...
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <button> <a href="#" class="btn">Thêm vào giỏ</a></button>
